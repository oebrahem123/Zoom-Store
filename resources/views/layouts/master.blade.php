...
<body class="animsition">
                ...
                <nav class="limiter-menu-desktop container">
                    ...
                    <div class="menu-desktop">
                        <ul class="main-menu" dir="rtl">
                            ...
                            <li class="{{ request()->is('reviews') ? 'active-menu' : '' }}">
                    ...
                    <div class="wrap-icon-header flex-w flex-r-m">
                        ...
                        <a href="/cart" class="icon-header-item icon-header-noti" data-notify="{{ $cartCount ?? 0 }}">
    ...
    <div class="floating-track-container">
        @if(session('last_order_id') && !request()->routeIs('order.confirmation'))
        <a href="{{ route('order.confirmation', session('last_order_id')) }}" class="floating-track-btn">
