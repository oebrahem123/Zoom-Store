...
<section class="contact-us p-t-140 p-b-140" id="contact-section">
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                <div id="map">
