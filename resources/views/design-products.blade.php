    ...
    <div class="container">
        ...
        <div class="flex-w justify-content-end p-b-52">
            ...
            <div class="dis-none panel-search w-full p-t-10 p-b-15" dir="rtl">
                <form action="/design-products/search" method="post">
            ...
            <div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm">
                ...
                <div class="filter-col4 p-b-27">
                    ...
                    <div class="flex-w p-t-4 m-r--5">
                        ...
                        {{-- ALL --}}
                        <a href="{{ url('/design-products') }}" class="flex-c-m stext-107 size-301 bor7 p-lr-15 trans-04 m-r-5 m-b-5
                   {{ request()->segment(2) == null ? 'filter-link-active' : 'cl6 hov-tag1' }}">
                        ...
                        <a href="{{ url('/design-products/'.$cat->id) }}" class="flex-c-m stext-107 size-301 bor7 p-lr-15 trans-04 m-r-5 m-b-5
            ...
            <div class="block2">
                ...
                <div class="block2-txt flex-w flex-t p-t-14">
                    <div class="block2-txt-child1 flex-col-l ">
                        ...
                        <span class="stext-106 cl8" style="font-size:12px;margin-top:4px;">
                            🎨 قابل للتصميم
                        </span>
                    </div>
